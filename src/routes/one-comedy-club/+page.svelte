...
<style>
  ...
  .occ-section-header--light h2 {
    color: var(--occ-white);
  }

  .occ-section-header--light h2::after {
    background: var(--occ-yellow);
  }
