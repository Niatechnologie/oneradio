...
<nav id="navbar" class="navbar">
  ...
  <div class="menu-desktop">
    ...
    <a class:active={isActiveRoute('/one-comedy-club')} href="/one-comedy-club">One Comedy</a>
...
<div class="ticker">
  ...
  <a href="/one-comedy-club"><i class="bi bi-emoji-laughing-fill"></i> One Comedy <i class="bi bi-chevron-right"></i></a>
