...
.audio-player:hover .progress-bar {
  height: 0.375rem;
}
...
.progress-fill {
  ...
  height: 100%;
  background-color: var(--primary);
  width: 30%; /* Initial position */
  border-radius: 9999px;
  transition: background-color 0.3s ease;
}

.audio-player:hover .progress-fill {
  background-color: var(--primary-dark);
}
...
<nav id="navbar" class="navbar">
  ...
  <div class="menu-desktop">
    ...
    <a class:active={isActiveRoute('/events/one-comedy-club')} href="/events/one-comedy-club">One Comedy</a>
...
<div class="ticker">
  ...
  <a href="/events/one-comedy-club"><i class="bi bi-emoji-laughing-fill"></i> One Comedy <i class="bi bi-chevron-right"></i></a>
