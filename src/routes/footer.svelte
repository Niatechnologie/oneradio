<script>
  ...
  /** @type {Props} */
  let { phone = "(+225) 27 22 30 54 75 | (+225) 0500 877 877", email = "contact@oneradio.ci", address = "Abidjan Cocody, Angré 8é tranche, non loin de la CNPS. One Radio 2é etage Porte B3" } = $props();
