  ...
  async function loadData() {
    ...
    try {
      ...
      const [paginatedResponse, allNewsResponse] = await Promise.all([
        fetch(`https://admin.radiotreichville.ci/radio_treich/listpodcasts.php?page=${currentPage}&limit=${itemsPerPage}&podcastId=${podcastsId}`),
        fetch(`https://admin.radiotreichville.ci/radio_treich/alllistpodcasts.php?podcastId=${podcastsId}`)
      ]);
